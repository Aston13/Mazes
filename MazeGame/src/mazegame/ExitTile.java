...
//    
//    public ExitTile(Tile[][] tiles, int startingX, int startingY, int passageCount) {
//        this.tiles = tiles;
...
//        
//        Tile[][] tiles = movePassage(startingX, startingY);
//    }
//    
//    
//    
...
//    }
//    
//    public Tile[][] movePassage(int x, int y) {
...
//            movePassage(visitedTiles.pop().getMinX(), visitedTiles.pop().getMinY());
//        } 
//        
//        return updateGrid;
//    }
