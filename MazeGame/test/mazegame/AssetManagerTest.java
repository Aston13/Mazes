...
class AssetManagerTest {
    ...
    void preloadImages() throws IOException {
        ...
        // Grass variants
        for (int i = 0; i < 4; i++) {
            assertNotNull(am.getPreloadedImage("GrassPassage_" + i),
                    "GrassPassage_" + i + " should be loaded");
        }
        ...
        // Key frames
        for (int i = 0; i < 20; i++) {
            assertNotNull(am.getPreloadedImage("Key_" + i),
                    "Key_" + i + " should be loaded");
        }
            ...
            for (int e = 0; e <= 1; e++) {
                for (int s = 0; s <= 1; s++) {
                    for (int w = 0; w <= 1; w++) {
                        ...
                        assertNotNull(am.getPreloadedImage(key),
